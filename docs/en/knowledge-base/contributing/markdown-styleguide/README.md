...
The documentation supports the [Markdown Markup Language](https://en.wikipedia.org/wiki/Markdown) (You can also find a "Cheatsheet" [here](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet))

Markdown can be written in various different styles, in this document you will find the standard formatting guide for creating documentation.
...
<!--- This page has been taken from https://github.com/RocketChat/docs/edit/master/contributing/documentation/markdown-styleguide/README.md --->
